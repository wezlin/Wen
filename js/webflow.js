 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    (r.env.safari = /safari/.test(g) && !y && !m),
      I &&
  ...
  function (t, e, n) {
    ...
    function Et(t) {
      var e = t.store,
        ...
        u = a.ixInstances,
        c =
          a.ixSession.hasBoundaryNodes && r ? m.getClosestElement(r, b) : null;
    ...
    function _t(t) {
      ...
      u >= g.length && (0, s.default)(v, "config.loop") && (u = 0),
        0 === u && I && u++;
      var y =
          (0 === u || (1 === u && I)) && nt(v.action && v.action.actionTypeId)
            ? v.config.delay
            : void 0,
  ...
  function (t, e, n) {
    n(99), n(53), n(102), n(258), n(259), n(260), (t.exports = n(261));
  },
  function (t, e, n) {
    "use strict";
    var r = n(8);
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, E, _, g) {
      ...
      if (b && !O)
        return (
          g || (g = new r()),
          I || f(t) ? i(t, e, n, E, _, g) : o(t, e, m, n, E, _, g)
        );
      if (!(n & l)) {
  ...
  function (t, e, n) {
            ...
            return (function (t, e, n, r, i) {
              ...
              Ct(t, I.TRANSFORM_PREFIXED, i),
                ...
                ((s === J && void 0 !== d) ||
                  ...
                  a(t, I.TRANSFORM_STYLE_PREFIXED, N);
              var u, c, s, f, l, d;
            })(t, e, n, i, a);
          case q:
                ...
                case ct:
                  ...
                  Ct(t, _, o),
                    a(
                      ...
                      _,
                      m >= 1
                        ? "rgb(".concat(g, ",").concat(I, ",").concat(y, ")")
                        : "rgba("
                            .concat(g, ",")
                            .concat(I, ",")
                            .concat(y, ",")
            ...
            return (function (t, e, n) {
              ...
              switch (e.actionTypeId) {
                case st:
                  ...
                  return void (i === C && I.IS_BROWSER_ENV
                    ? r(t, k, I.FLEX_PREFIXED)
                    : r(t, k, i));
              }
            })(t, i, a);
          case $:
    ...
    var f = s(n(195)),
      ...
      pt = Object.freeze(
        ((i = {}),
        (0, c.default)(i, I.TRANSFORM_PREFIXED, T),
        (0, c.default)(i, M, m),
        (0, c.default)(i, L, L),
        (0, c.default)(i, x, x),
        (0, c.default)(i, D, D),
    ...
    function It(t) {
      ...
      if (
        (C
          ? ((S = N.limitAffectedElements), (R = L), (w = u(N)))
    ...
    function Dt(t) {
      ...
      e.actionItems.forEach(function (t) {
        ...
        (e = (0, g.isPluginType)(i)
          ...
          It({ config: o, event: n, elementApi: r }).forEach(e);
      });
    }
    var Pt = function (t) {
      var e = t.effect,
    ...
    t.exports = function (t, e, n) {
      ...
      function O() {
        ...
        if (((s = arguments), (f = this), (v = t), n)) {
          if (void 0 === p)
            return (function (t) {
              return (h = t), (p = setTimeout(m, e)), E ? I(t) : d;
            })(v);
      ...
      _t =
        ...
        (0, o.default)(r, P, {
          ...
          handler: function (t) {
            ...
            return (
              A && (b > 0.95 || b < 0.05) && (b = Math.round(b)),
              (u !== h.EventBasedOn.ELEMENT || R || R !== a.elementHovered) &&
                ((b = f ? 1 - b : b),
                e.dispatch((0, _.parameterChanged)(S, b))),
              { elementHovered: R, clientX: v, clientY: g, pageX: y, pageY: T }
            );
          },
        }),
        (0, o.default)(r, W, {
    ...
    r.define(
      ...
      (t.exports = function (t, e) {
        var n,
          ...
          b = t(document);
        function S() {
          (n = f && r.env("design")), (u = b.find(p)).each(R);
        }
        function R(e, i) {
          var u = t(i),
            s = t.data(i, p);
          ...
          n &&
            ...
            n ||
              ...
              s.el.on(
                ...
                (function (t) {
                  return c(function (e) {
                    var n = t.el[0].contains(e.relatedTarget);
                    n || L(t);
                  });
                })(s)
              ),
        ...
        function C(e) {
          if (!e.open) {
            ...
            var i = r.env("editor");
            n || b.on(T, e.mouseUpOutside),
              e.hovering && !i && e.el.on(m, e.mouseLeave),
              e.hovering && i && b.on(y, e.mouseMoveOutside),
        ...
        function L(t) {
          ...
          if (t.open && (!t.config.hover || !t.hovering || r)) {
            ...
            if (
              (h.outro(0, t.el[0]),
              b.off(T, t.mouseUpOutside),
              b.off(y, t.mouseMoveOutside),
  ...
  events: {
    e: {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5ea1b995c6b4c13faa406a09|a4177896-a5e5-6c6a-0980-01ce8ea2054a",
      },
      config: {
        loop: false,
        playInReverse: false,
